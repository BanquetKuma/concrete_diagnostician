class Gomoku:
    """docstring for Gomoku
    object for playing Gomoku (Five in a Row) game"""
    def __init__(self, size=15):
        """docstring for __init__
        Initialize the Gomoku board with the given size.
        Args:
    ...
    def is_valid_move(self, x, y):
        ...
        Returns:
            bool: True if the move is within the bounds of the board and the cell is empty ('.'), False otherwise.
        """
